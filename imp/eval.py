...
parser.add_argument('--pydir', type=str, default=r"/opt/apps/software/Python/3.8.6-GCCcore-10.2.0/bin/python", help='python directory')
parser.add_argument('--dir', type=str, default=r"/home/yf22/R50_nat/checkpoints", help='mask directory')
parser.add_argument('--arch', type=str, default="resnet50", help='resnet18 , resnet50')
...
for mask in mask_list:
    ...
    shell_code = f"HIP_VISIBLE_DEVICES={args.cuda} {args.pydir} main_eval_downstream.py --arch {args.arch} --set {args.ds} --epochs 150 --batch-size 256 --lr 0.001 --name {fn_head + '_' + sp + '_' + fn_ds} --weight_dir {init_weight} --mask_dir {mask} --trainer tune --attack_type None --workers {args.workers} --momentum 0.9 --wd 5e-4 --save-model"
    log.info(shell_code)
