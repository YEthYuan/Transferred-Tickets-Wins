...
parser.add_argument('--name', default='R50_Linf_Eps2', type=str, help='experiment name')
parser.add_argument('--model-path', type=str, default='/home/yf22/ResNet_ckpt/resnet50_linf_eps2.0.ckpt', help='path of the pretrained weight')
