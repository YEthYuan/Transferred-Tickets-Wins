"""
        Experiment Name: Evaluate the 'Learnable Mask' subnetwork in downstream classification tasks
"""
...
def main_worker(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # pruning the pretrained model after whole pretrain process
        if args.task == 'sup_pt' and epoch == args.epochs - 1:
            print('L1 pruning')
        ...
        if epoch % args.val_every == 0 or epoch == args.epochs - 1:
            ...
            if args.task == 'sup_pt' and epoch == args.epochs - 1:
                save_checkpoint(
                    ...
                    is_best,
                    filename=ckpt_base_dir / f"subnetwork.state",
                    save=True,
                )
